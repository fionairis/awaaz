@extends('layouts.frontlayout.users.master')
@section('content')
									...
									<div class="posts-section">
										<div class="post-bar">
											...
											<div class="job-status-bar">
												<ul class="like-com">
													<li>
														<a href="index.html#"><i class="la la-heart"></i> Like</a>
														<img src="images/liked-img.png" alt="">
														<span>25</span>
													</li> 
													<li><a href="index.html#" title="" class="com"><img src="images/com.png" alt=""> Comment 15</a></li>
												</ul>
										...
										<div class="process-comm">
											<a href="index.html#" title=""><img src="images/process-icon.png" alt=""></a>
							...
							<div class="col-lg-3 pd-right-none no-pd">
								<div class="right-sidebar">
									<div class="widget widget-about">
										...
										<div class="sign_link">
											<h3><a href="index.html#" title="">Sign up</a></h3>
